...
---info---
Try to use Github Action to solve.
But there are something wrong these days.
Hope for better solution.
    ZhiyuShang 2021.05.22
--- end---
'''
...
def main(sid, userid):
    ...
    api = "https://sc.ftqq.com/SCU138613Tf980299c10ed0bc98b9620d68af8f0635fe415a3271b3.send"
    title = "Dk-WPS打卡通知"
    data = {
        "text": title,
        "desp": content
...
if __name__ == "__main__":
    main(sid='V02Sgd4txnsqzDTnN6ut6Llo0jzgI7w00aabade8000077e820', userid='7858208')
